...
realpx = [.106,.106,.199];               % Dimensions of a single voxel. Used to calculate sizes, choose units carefully. By default in micrometer.
particlediameter = 1.72;                    % Give the approximate particle diameter in µm
...
edgenode_dist = 3;                          % Sets the region in which nodes exist are defined as edge nodes, in units of µm. It is recommended to set this larger than 1.5 sigma.
