function [node,link] = skel2graph_thoroughclean(skel,threshold,realpx,cl_thr)
% SKEL2GRAPH_THOROUGHCLEAN creates graph files from a skeleton, and applies
% cleaning, removing nodes only twice connected, non-connected nodes, 
% unnecessarily kept node voxels, and terminal nodes shorter than a 
% threshold length. 
...
[node, link] = thoroughclean(node,link,cc2.NumObjects,[w,l,h],threshold,realpx);
