...
% VISUALIZE_PRECLEAN visualizes images and skeletons before the cleaning
% routines are applied. Tool for optimization.
    ...
    vis_bin_skel(skel,enlargednodes,Ifl,[pathstr,'/Output/',fname,'/Post-skeletonization_uncleaned.tif'])
