function tort_summary = wrapup_tortuosity(tort_data,projectpath,dtortuosity,switch_exporttxt)
...
if strcmp(switch_exporttxt,'yes') == 1
	...
	fileid2 = fopen([projectpath,'/Output/tortuosity_combined_perimage.txt'],'w');
