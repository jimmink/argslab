function exporttxt_tort(a,tort_data,dtortuosity,dxpath,dypath,dzpath,dxeucl,dyeucl,dzeucl,dxtortuosity,dytortuosity,dztortuosity,pathstr,fname,switch_optimizationtools)
...
fprintf(fileidsum,[num2str(tort_data(a,1)),'\t',num2str(tort_data(a,2)),'\n']);
fprintf(fileidsum,'\n');
fprintf(fileidsum,'In x-direction\tIn y-direction\tIn z-direction\n');
fprintf(fileidsum,[num2str(dtortuosity(a,1)),'\t',num2str(dtortuosity(a,2)),'\t',num2str(dtortuosity(a,3)),'\n']);
fclose(fileidsum);
